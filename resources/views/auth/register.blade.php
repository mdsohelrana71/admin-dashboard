...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-left a:hover { background: #fff; color: #667eea; }
        .auth-right {
            width: 60%;
            background: #fff;
            display: flex;
        ...
        <form method="POST" action="{{ route('register') }}" style="width:100%">
            ...
            <div class="input-group-icon" style="position:relative;">
                ...
                <input type="password" name="password" id="reg_password" class="form-control"
                    placeholder="Password" style="padding-right:40px;" required>
                <i class="fas fa-eye" id="toggleRegPassword"
                    ...
                    onclick="togglePass('reg_password','toggleRegPassword')"></i>
            </div>
            <div class="input-group-icon" style="position:relative;">
                <i class="fas fa-lock"></i>
                <input type="password" name="password_confirmation" id="reg_confirm" class="form-control"
                    placeholder="Confirm Password" style="padding-right:40px;" required>
                <i class="fas fa-eye" id="toggleRegConfirm"
                    style="position:absolute;left:95%;top:50%;transform:translateY(-50%);cursor:pointer;color:#a0aec0;z-index:10;"
                    onclick="togglePass('reg_confirm','toggleRegConfirm')"></i>
            </div>

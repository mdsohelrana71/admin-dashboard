...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-left a:hover { background: #fff; color: #11998e; }
        .auth-right {
            width: 60%;
            background: #fff;
            display: flex;
    ...
    <div class="auth-right">
        ...
        <form method="POST" action="{{ route('login') }}" style="width:100%">
            ...
            <div class="input-group-icon" style="position:relative;">
                <i class="fas fa-lock" style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:#a0aec0;z-index:10;"></i>
                ...
                <i class="fas fa-eye" id="togglePassword"
                    ...
                    onclick="togglePass('password','togglePassword')"></i>
            </div>
